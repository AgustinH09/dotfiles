---
name: review-bugbot
description: Review code changes for real bugs with the bugbot subagent. Use when the user asks to run /review-bugbot or to bug-review the current diff/branch/PR.
metadata:
  origin: cursor
---
...
Launch exactly one `bugbot` subagent with the Task tool:

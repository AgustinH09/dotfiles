...
description: Review code changes for vulnerabilities with the security-review subagent. Use when the user asks to run /review-security or to security-review the current diff/branch/PR.
metadata:
  origin: cursor
---
...
Launch exactly one `security-review` subagent with the Task tool:

- `subagent_type: "security-review"`
- `description: "Security Review"`
- Run it in the foreground (wait for its result) unless the user explicitly asked for background.
